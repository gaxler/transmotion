...
class ThinPlateSpline:
    ...
    def random(
        ...
        control_params = th.normal(
            # TODO: this needs to have tps sigma and affien sigma. make sure i decouple those when this becomes real
            mean=0,
